...
Plan maestro del **producto completo**: no es solo la app de campo. Cubre **fundación (Fase 0)**, **App Satélite** (MVP de operaciones en tienda/campo), **ERP básico** (MVP administrativo), **ERP completo**, **CRM** y **offline-first**. Este documento vive en el repo **erp-satelite**; si en tu máquina usas una carpeta monorepo local (`ERP/`) con scripts en la raíz, el código de producto sigue siendo este repositorio.
...
**Stack por fase:** [STACK_POR_FASE.md](./STACK_POR_FASE.md).
...
**Vista por sprints (T01–T35, ~14 semanas):** [ROADMAP.md](../ROADMAP.md) en la raíz del repo.
...
| T0.1.6 | Documentar columnas en EXCEL_ANALYSIS.md        | 1h    | Alta      | **En progreso** (ver [EXCEL_ANALYSIS.md](./EXCEL_ANALYSIS.md)) |
