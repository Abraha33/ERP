...
**Línea base aceptada** (ADR-001 + revisión **2026-04-08**; detalle en [CONTEXT.md](../../.cursor/context/CONTEXT.md)):
...
3. **Con Cursor / IA:** enlaza [CONTEXT.md](../../.cursor/context/CONTEXT.md) + **esta página** para no mezclar tecnologías de fases futuras en código actual.
