...
|--------|-------|------|-------|-----------|
| T01 | Stack definido en README y ADR | Markdown | 2h | Alta |
...
## FASE 3: APP SATELITE MOVIL (Semana 5-6)
| Ticket | Tarea | Tech | Horas | Prioridad |
|--------|-------|------|-------|-----------|
...
## FASE 4: RECEPCION Y TRASLADOS (Semana 7-8)
| Ticket | Tarea | Tech | Horas | Prioridad |
|--------|-------|------|-------|-----------|
| T16 | Recepcion de mercancia (formulario) | Expo, Supabase | 4h | Alta |
...
## FASE 5: MISIONES Y ARQUEO MVP (Semana 9-10)
| Ticket | Tarea | Tech | Horas | Prioridad |
|--------|-------|------|-------|-----------|
...
| T23 | Arqueo de caja (formulario) | Expo, Supabase | 3h | Alta |
...
## FASE 6: WEB OFICINA (Semana 11-12)
| Ticket | Tarea | Tech | Horas | Prioridad |
|--------|-------|------|-------|-----------|
...
## FASE 7: CRM BASICO (Semana 13-14)
| Ticket | Tarea | Tech | Horas | Prioridad |
|--------|-------|------|-------|-----------|
