...
- [ ] .gitignore configurado (node_modules, .env, __pycache__, etc.)
- [ ] .env.example con variables necesarias (sin valores reales)
- [ ] README con sección "Cómo ejecutar localmente"
- [ ] Rama `develop` creada; PRs feature → develop → main documentado (ver README §3.2)
